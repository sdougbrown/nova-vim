...
call s:highlight_helper("typescriptTemplate", "#7FC1CA", "")
call s:highlight_helper("typescriptStringLiteralType", "#7FC1CA", "")
call s:highlight_helper("typescriptTemplateLiteralType", "#7FC1CA", "")
...
call s:highlight_helper("typescriptFuncArg", "#83AFE5", "")
call s:highlight_helper("typescriptArrowFuncArg", "#83AFE5", "")
call s:highlight_helper("typescriptParamImpl", "#83AFE5", "")
call s:highlight_helper("typescriptObjectLabel", "#83AFE5", "")
call s:highlight_helper("typescriptDestructureVariable", "#83AFE5", "")
call s:highlight_helper("typescriptDestructureLabel", "#83AFE5", "")
call s:highlight_helper("typescriptTypeReference", "#83AFE5", "")
call s:highlight_helper("typescriptAliasDeclaration", "#83AFE5", "")
call s:highlight_helper("typescriptTypeParameter", "#83AFE5", "")
...
" TSX (vim-polyglot typescriptreact syntax uses tsx* groups)
call s:highlight_helper("tsxTagName", "#9A93E1", "")
call s:highlight_helper("tsxIntrinsicTagName", "#9A93E1", "")
call s:highlight_helper("tsxAttrib", "#A8CE93", "")
call s:highlight_helper("tsxCloseTag", "#DF8C8C", "")
call s:highlight_helper("tsxCloseString", "#DF8C8C", "")
call s:highlight_helper("tsxString", "#DADA93", "")
call s:highlight_helper("tsxEqual", "#899BA6", "")
call s:highlight_helper("tsxTag", "#DF8C8C", "")
call s:highlight_helper("tsxCommentInvalid", "#899BA6", "")
...
call s:highlight_helper("typescriptFuncName", "#DADA93", "")
call s:highlight_helper("typescriptFuncDef", "#DADA93", "")
call s:highlight_helper("typescriptMember", "#DADA93", "")
call s:highlight_helper("typescriptGlobalMethod", "#DADA93", "")
call s:highlight_helper("typescriptTestGlobal", "#DADA93", "")
call s:highlight_helper("typescriptStatementKeyword", "#DADA93", "")
call s:highlight_helper("typescriptInterfaceName", "#DADA93", "")
...
call s:highlight_helper("typescriptAsyncFuncKeyword", "#A8CE93", "")
call s:highlight_helper("typescriptAsyncFunc", "#A8CE93", "")
call s:highlight_helper("typescriptClassKeyword", "#A8CE93", "")
call s:highlight_helper("typescriptClassExtends", "#A8CE93", "")
call s:highlight_helper("typescriptInterfaceKeyword", "#A8CE93", "")
call s:highlight_helper("typescriptInterfaceExtends", "#A8CE93", "")
call s:highlight_helper("typescriptAbstract", "#A8CE93", "")
call s:highlight_helper("typescriptClassStatic", "#A8CE93", "")
call s:highlight_helper("typescriptReadonlyModifier", "#A8CE93", "")
call s:highlight_helper("typescriptAliasKeyword", "#A8CE93", "")
call s:highlight_helper("typescriptPredefinedType", "#A8CE93", "")
call s:highlight_helper("typescriptType", "#A8CE93", "")
call s:highlight_helper("typescriptConstraint", "#A8CE93", "")
call s:highlight_helper("typescriptAccessibilityModifier", "#A8CE93", "")
...
call s:highlight_helper("typescriptIdentifier", "#9A93E1", "")
call s:highlight_helper("typescriptGlobalObjects", "#9A93E1", "")
call s:highlight_helper("typescriptGlobalNodeObjects", "#9A93E1", "")
call s:highlight_helper("typescriptConstructor", "#9A93E1", "")
call s:highlight_helper("typescriptDecorator", "#9A93E1", "")
call s:highlight_helper("typescriptUserDefinedType", "#9A93E1", "")
...
call s:highlight_helper("typescriptCastKeyword", "#F2C38F", "")
call s:highlight_helper("typescriptTry", "#F2C38F", "")
call s:highlight_helper("typescriptExceptions", "#F2C38F", "")
...
call s:highlight_helper("typescriptTemplateSB", "#7FC1CA", "")
call s:highlight_helper("typescriptCommentSkip", "#899BA6", "")
call s:highlight_helper("typescriptDotNotation", "#899BA6", "")
call s:highlight_helper("typescriptFuncComma", "#899BA6", "")
call s:highlight_helper("typescriptMethodAccessor", "#899BA6", "")
call s:highlight_helper("typescriptOptionalMark", "#899BA6", "")
call s:highlight_helper("typescriptUnion", "#899BA6", "")
